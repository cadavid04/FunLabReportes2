 ...
 */
public class ReportLab2View extends FrameView {
    
    public ReportLab2View(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        reportlab2.Clientes c = new reportlab2.Clientes();
    ...
    public void deleteRecord() {
        ...
        List<reportlab2.Clientes> toRemove = new ArrayList<reportlab2.Clientes>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            reportlab2.Clientes c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<reportlab2.Clientes> merged = new ArrayList<reportlab2.Clientes>(list.size());
                for (reportlab2.Clientes c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ReportLab2App.getApplication().getMainFrame();
            aboutBox = new ReportLab2AboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ReportLab2App.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(reportlab2.ReportLab2App.class).getContext().getResourceMap(ReportLab2View.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(reportlab2.ReportLab2App.class).getContext().getActionMap(ReportLab2View.class, this);
    ...
    private java.util.List<reportlab2.Clientes> list;
